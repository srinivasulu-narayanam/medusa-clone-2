import { createProductVariantsWorkflow } from "@srinivasulu-narayanam/core-flows"
...
import { refetchEntities, refetchEntity } from "@srinivasulu-narayanam/framework/http"
import {
  remapKeysForProduct,
  remapKeysForVariant,
