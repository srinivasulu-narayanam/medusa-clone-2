import { CustomerDTO, ICustomerModuleService } from "@srinivasulu-narayanam/framework/types"
import { isDefined, Modules, validateEmail } from "@srinivasulu-narayanam/framework/utils"
