...
The icons are available as an [npm package](https://www.npmjs.com/package/@srinivas-narayanam/icons). To install the package run:

<PackageInstall packageName="@srinivas-narayanam/icons" />

## Usage
---

```tsx
import { Sun } from "@srinivas-narayanam/icons"
