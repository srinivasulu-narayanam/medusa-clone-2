...
- `@srinivas-narayanam/ui` - React components, hooks, and utility functions used
  in Medusa UI.
- `@srinivas-narayanam/ui-preset` - Tailwind CSS preset containing all the classes
  used in Medusa UI.
- `@srinivas-narayanam/icons` - Icons used in Medusa UI.
