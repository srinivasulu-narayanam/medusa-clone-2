...
This documentation provides a reference to the `deleteProductOptionsWorkflow`. It belongs to the `@srinivas-narayanam/medusa/core-flows` package.
...
```ts
import { deleteProductOptionsWorkflow } from "@srinivas-narayanam/medusa/core-flows"
