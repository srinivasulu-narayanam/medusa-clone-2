...
This documentation provides a reference to the `deleteProductsWorkflow`. It belongs to the `@srinivas-narayanam/medusa/core-flows` package.
...
```ts
import { deleteProductsWorkflow } from "@srinivas-narayanam/medusa/core-flows"
