...
This documentation provides a reference to the `deleteProductTypesWorkflow`. It belongs to the `@srinivas-narayanam/medusa/core-flows` package.
...
```ts
import { deleteProductTypesWorkflow } from "@srinivas-narayanam/medusa/core-flows"
