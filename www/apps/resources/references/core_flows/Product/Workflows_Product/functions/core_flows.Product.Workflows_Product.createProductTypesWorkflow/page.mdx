...
This documentation provides a reference to the `createProductTypesWorkflow`. It belongs to the `@srinivas-narayanam/medusa/core-flows` package.
...
```ts
import { createProductTypesWorkflow } from "@srinivas-narayanam/medusa/core-flows"
