...
This documentation provides a reference to the `deleteProductTagsWorkflow`. It belongs to the `@srinivas-narayanam/medusa/core-flows` package.
...
```ts
import { deleteProductTagsWorkflow } from "@srinivas-narayanam/medusa/core-flows"
