...
This documentation provides a reference to the `updateProductTypesWorkflow`. It belongs to the `@srinivas-narayanam/medusa/core-flows` package.
...
```ts
import { updateProductTypesWorkflow } from "@srinivas-narayanam/medusa/core-flows"
