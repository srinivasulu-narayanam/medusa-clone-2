...
This documentation provides a reference to the `deleteCollectionsWorkflow`. It belongs to the `@srinivas-narayanam/medusa/core-flows` package.
...
```ts
import { deleteCollectionsWorkflow } from "@srinivas-narayanam/medusa/core-flows"
