...
This documentation provides a reference to the `deleteCustomersWorkflow`. It belongs to the `@srinivas-narayanam/medusa/core-flows` package.
...
```ts
import { deleteCustomersWorkflow } from "@srinivas-narayanam/medusa/core-flows"
