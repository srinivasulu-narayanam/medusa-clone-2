...
Create the file `src/modules/my-payment/service.ts` that holds the module's main service. It must extend the `AbstractPaymentProvider` class imported from `@srinivas-narayanam/framework/utils`:

```ts title="src/modules/my-payment/service.ts"
import { AbstractPaymentProvider } from "@srinivas-narayanam/framework/utils"
...
module.exports = defineConfig({
  ...
  modules: [
    {
      resolve: "@srinivas-narayanam/medusa/payment",
      options: {
        providers: [
          {
