  ...
  modules: [
    {
      ...
      options: {
        providers: [
          // ...
          {
            resolve: "@srinivas-narayanam/medusa/notification-sendgrid",
            id: "sendgrid",
            options: {
              channels: ["email"],
...
import { Modules } from "@srinivas-narayanam/framework/utils"
import { INotificationModuleService } from "@srinivas-narayanam/framework/types"
...
export default async function productCreateHandler({
  ...
  await notificationModuleService.createNotifications({
    to: "test@gmail.com",
    from: "test@srinivas-narayanam.com", // Optional var, verified sender required
    channel: "email",
