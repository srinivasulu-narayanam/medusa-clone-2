...
```bash npm2yarn
npm install @srinivas-narayanam/js-sdk@latest @srinivas-narayanam/types@latest
```

You install two libraries:

- `@srinivas-narayanam/js-sdk`: the Medusa JS SDK.
- `@srinivas-narayanam/types`: Medusa's types library, which is useful if you're using TypeScript in your development.
...
import { Button, Container } from "@srinivas-narayanam/ui"
import { useQuery } from "@tanstack/react-query"
import { sdk } from "../lib/config"
import { DetailWidgetProps, HttpTypes } from "@srinivas-narayanam/framework/types"
