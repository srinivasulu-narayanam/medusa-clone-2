import { AcademicCapSolid, UsersSolid } from "@srinivas-narayanam/icons"
...
{/* <Details summaryContent="Example">
  ...
  import { CustomerGroupDTO } from "@srinivas-narayanam/framework/types"
...
export const workflowHighlights = [
  ...
  import { CreateCustomerGroupDTO } from "@srinivas-narayanam/framework/types"
...
export const checkCustomerHighlights = [
  ...
  import { ICustomerModuleService } from "@srinivas-narayanam/framework/types"
  import B2bModuleService from "../../../../modules/b2b/service"
  ...
  --data-raw '{
      "email": "test@srinivas-narayanam.com",
