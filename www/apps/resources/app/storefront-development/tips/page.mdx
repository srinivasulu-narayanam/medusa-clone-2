...
The `@srinivas-narayanam/types` package provide API routes' request and response types.

If you're not using the JS SDK, install `@srinivas-narayanam/types` to use the correct request and response types:

```bash npm2yarn
npm install @srinivas-narayanam/types@latest
```
