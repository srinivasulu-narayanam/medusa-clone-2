...
} from "@srinivas-narayanam/medusa/dist/api/admin/api-keys" // <-- Not allowed
```

## Importing from Exposed Directories

The `@srinivas-narayanam/medusa` package allows you to import from the following sub-directories:
...
import { 
  AdminGetApiKeysParams,
} from "@srinivas-narayanam/medusa/api/admin/api-keys" // <-- Allowed
```
