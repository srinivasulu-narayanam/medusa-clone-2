...
Use the `ContainerRegistrationKeys` enum imported from `@srinivas-narayanam/framework/utils` where specified.
...
<Table>
  ...
  <Table.Body>
    ...
    <Table.Row>
      ...
      - For Medusa's commerce modules, use the `Modules` enum imported from `@srinivas-narayanam/framework/utils`.
