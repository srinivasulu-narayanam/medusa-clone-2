...
import { ExecArgs } from "@srinivas-narayanam/framework/types"
...
You create the generated products using the `createProductsWorkflow` imported previously from `@srinivas-narayanam/medusa/core-flows`. It accepts the product data as input, and returns the created products.
