...
To use this schema for validating the body parameters of requests to `/custom`, use the `validateAndTransformBody` middleware provided by `@srinivas-narayanam/framework/http`. It accepts the Zod schema as a parameter.
