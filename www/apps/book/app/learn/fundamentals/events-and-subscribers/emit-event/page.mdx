...
To emit a workflow event, use the `emitEventStep` helper step provided in the `@srinivas-narayanam/medusa/core-flows` package.
...
import { IEventBusService } from "@srinivas-narayanam/framework/types"
